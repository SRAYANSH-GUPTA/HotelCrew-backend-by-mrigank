    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_license', models.FileField(blank=True, null=True, upload_to='documents/licenses/')),
                ('insurance_documents', models.FileField(blank=True, null=True, upload_to='documents/insurance/')),
            ],
        ),
        migrations.CreateModel(
            name='RoomType',
